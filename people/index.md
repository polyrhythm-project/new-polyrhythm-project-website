...
<div style="font-size:1.65rem; word-spacing:2px; letter-spacing:0.35px; margin-bottom:40px; color:var(--secondary-dark)">Missing Examples Encoding Marathon, December 6, 2019; <i>left to right</i>: Alex Negri, Anna Wright, Kelsey Lussier, and Isaac Zee.</div>
